...
/** 受控命令代理入口(verifier-command.ts);Bash 允许的唯一工具形态的绝对路径。 */
export const VERIFIER_COMMAND_ENTRY = join(packageRoot, "src", "strategies", "differential-smoke", "verifier-command.ts");
